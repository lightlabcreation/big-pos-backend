...
try {
    $loginResponse = Invoke-RestMethod -Uri 'http://localhost:9000/store/auth/login' -Method POST -Body $loginBody -ContentType 'application/json'
...
try {
    $profile = Invoke-RestMethod -Uri 'http://localhost:9000/store/customers/me' -Method GET -Headers $headers
...
try {
    $wallets = Invoke-RestMethod -Uri 'http://localhost:9000/store/wallets' -Method GET -Headers $headers
...
try {
    $meters = Invoke-RestMethod -Uri 'http://localhost:9000/store/gas/meters' -Method GET -Headers $headers
...
try {
    $rewards = Invoke-RestMethod -Uri 'http://localhost:9000/store/gas/rewards/balance' -Method GET -Headers $headers
...
try {
    $history = Invoke-RestMethod -Uri 'http://localhost:9000/store/gas/rewards/history' -Method GET -Headers $headers
...
try {
    $leaderboard = Invoke-RestMethod -Uri 'http://localhost:9000/store/gas/rewards/leaderboard?period=month' -Method GET -Headers $headers
...
try {
    $orders = Invoke-RestMethod -Uri 'http://localhost:9000/store/customers/me/orders' -Method GET -Headers $headers
...
try {
    $transactions = Invoke-RestMethod -Uri 'http://localhost:9000/store/wallets/transactions' -Method GET -Headers $headers
...
try {
    $usage = Invoke-RestMethod -Uri 'http://localhost:9000/store/gas/usage' -Method GET -Headers $headers
